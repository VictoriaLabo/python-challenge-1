        ...
        if int(menu_category) in menu_items.keys():
            ...
            if item_number.isdigit():
                ...
                if item_number in menu_items.keys():
                    ...
                    # Handle the 3 for 2.50 cookie option
                    if item_name == "Cookie - 3 for 2.50":
                        flavors = ["Chocolate Chip", "Oatmeal", "S'mores"]
                        selected_flavors = []
                        for i in range(3):
                            while True:
                                flavor = input(f"Select flavor {i + 1} (Chocolate Chip, Oatmeal, S'mores): ")
                                if flavor in flavors:
                                    selected_flavors.append(flavor)
                                    break
                                else:
                                    print("Invalid flavor. Please choose again.")
                        item_name = f"3 Cookies ({', '.join(selected_flavors)})"
...
# added 3 for cookie option
# modified item selection logic to ask the cx. specific cookie choices in this scenario
# added sales tax to the receipt